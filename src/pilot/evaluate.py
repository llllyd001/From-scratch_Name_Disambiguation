...
DATA = Path("dataset/data/NA_Demo/SND/valid")
...
def main():
    ...
    input_path = args.input or Path("result/pilot") / f"{args.name}_llm_coarse.json"
    output_path = args.output or Path("result/pilot") / f"{args.name}_llm_coarse_evaluated.json"
